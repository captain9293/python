...
pat3 = '<h3><a href="htm_data\\/[0-9]\\/[0-9]+\\/[0-9]+\\.html" target="_blank" id="">.*美熟.*' #帖子标题规则
...
print('正在拼装网页主体....')
for i in range(1, 10):
    pageurl = 'http://cl.7sh.pw/thread0806.php?fid=2&search=&page=%d'%i #进入亚洲无码区
    print(pageurl)
...
f = open('中国五好青年学习资料%s.html'%tim, 'w', encoding='UTF-8')
f.write(html)
f.close()
